...
public class FiredVerdantCanister : FiredCanisterProjectile
{
	...
	public override void OnExplode() {
		...
		for (int i = 0; i < 4; i++) {
			...
			var vine = Projectile.NewProjectileDirect(Projectile.GetSource_FromThis(), Projectile.Center + offset, Vector2.Zero, ModContent.ProjectileType<VerdantVine>(), Projectile.damage, Projectile.knockBack / 3f, Projectile.owner, numVines, vineRot);
